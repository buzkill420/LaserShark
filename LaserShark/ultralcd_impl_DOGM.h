...
void lcd_printPGM_utf(const char *str, uint8_t n=LCD_WIDTH) {
  ...
  //Mine1
  u8g.drawBitmapP(0,1,CEILING(CUSTOM_BOOTSCREEN_BMPWIDTH, 8),CUSTOM_BOOTSCREEN_BMPHEIGHT,custom_start_bmp);
  u8g.drawBitmapP(52,5,E1_WIDTH,E1_HEIGHT,Endurance1_bmp);          
  u8g.drawBitmapP(118,5,E2_WIDTH,E2_HEIGHT,Endurance2_bmp);      
            // Welcome message
